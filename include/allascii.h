...
**
** (control characters are blank)
**
** all characters are represented as 5x7 grids the
** rightmost 3 bits are always blank and the
** last row (byte) is also blank.
**
**  !"#$%&'()*+,-./0123456789:;<=>?
